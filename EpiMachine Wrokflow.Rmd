...
DNMTs_retrieve <- data.frame(QUERY=paste(">",DNMTs_top$qseqid,"_",DNMTs_top$sseqid, sep = ""), START=DNMTs_top$sstart, STOP=DNMTs_top$send, SUBJECT=DNMTs_top$sseqid)
...
DUE_retrieve <- data.frame(QUERY=paste(">",DUE_top$qseqid,"_",DUE_top$sseqid, sep = ""), START=DUE_top$sstart, STOP=DUE_top$send, SUBJECT=DUE_top$sseqid)
